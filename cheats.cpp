...
void gtav_cheats::show_menu()
{
	if (m_show)
	{
		...
		std::cout << "[SHIFT] + [0] \t 角色属性全满" << std::endl;
		std::cout << "[SHIFT] + [1] \t 零食防弹衣全满" << std::endl;
		std::cout << "[SHIFT] + [2] \t 解锁改车配件" << std::endl;
		std::cout << "[SHIFT] + [3] \t 解锁武器涂装" << std::endl;
		std::cout << "[SHIFT] + [4] \t 解锁批发价" << std::endl;
		std::cout << "[SHIFT] + [5] \t 解锁奖章" << std::endl;
		std::cout << "[SHIFT] + [6] \t 解锁衣服" << std::endl;
